    ...
    <div class="header-bottom">
        ...
        <div class="top-nav">
            <ul class="memenu skyblue"><li class="active"><a href="index.html">Home</a></li>
                <li class="grid"><a href="#">Config</a>
                </li>
                <li class="grid"><a href="#">Models</a>
                    <div class="mepanel">
                        <div class="row">
                            <div class="col1 me-one">
                                <ul>
                                    <li><a href="product.html">Porsche 718</a></li>
                                    <li><a href="product.html">Porsche 911</a></li>
                                 </ul>
                            </div>
                            <div class="col1 me-one">
                                <ul>
                                    <li><a href="product.html">Porsche Cayenne</a></li>
                                    <li><a href="product.html">Porsche Macan</a></li>
                                 </ul>
                            </div>
                            <div class="col1 me-one">
                                <ul>
                                    <li><a href="product.html">Porsche Panamera</a></li>
                                    <li><a href="product.html">Porsche Taycan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="items-sec">
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/718.png" alt=""/>
            ...
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/911.png" alt=""/>
                    <div class="arrival-info">
                        <h4>Lighting #1</h4>
                        <p>Rs 8500</p>
            ...
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/taycan.png" alt=""/>
                    <div class="arrival-info">
                        <h4>Lighting #1</h4>
                        <p>Rs 12000</p>
        ...
        <div class="items-sec btm-sec">
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/panamera.png" alt=""/>
                    <div class="arrival-info">
                        <h4>Lighting #1</h4>
                        <p>Rs 500</p>
            ...
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/cayenn.png" alt=""/>
                    <div class="arrival-info">
                        <h4>Lighting #1</h4>
                        <p>Rs 400</p>
            ...
            <div class="col-md-3 feature-grid">
                <a href="product.html"><img src="images/macan.png" alt=""/>
                    <div class="arrival-info">
                        <h4>Lighting #1</h4>
                        <p>Rs 800</p>
        ...
        <div class="offer-grids">
            <div class="col-md-6 grid-left">
                <a href="#"><div class="offer-grid1">
                        <div class="ofr-pic">
                            <img src="images/cayenn.png" class="img-responsive" alt=""/>
                        </div>
            ...
            <div class="col-md-6 grid-right">
                <a href="#"><div class="offer-grid2">
                        ...
                        <div class="ofr-pic2">
                            <img src="images/718.png" class="img-responsive" alt=""/>
                        </div>
                        <div class="clearfix"></div>
                    </div></a>
            </div>
